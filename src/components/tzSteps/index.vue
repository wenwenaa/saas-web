<template>
  <div class="steps">
    <div :class="['circle1',stepsList[0].nowApproveFlag==='Y'&&(!newStepsList.length||newStepsList[0].nowApproveFlag==='N')?'active-circle':'step-line-circle']" v-if="stepsList.length">
    ...
    <div v-if="stepsList.length>1" class="wrap">
      <div class="wrap-item" v-for="(step,index) in newStepsList" :key="index">
        <div :class="[newStepsList[index].nowApproveFlag==='Y'?'step-active':'','step-line']">
