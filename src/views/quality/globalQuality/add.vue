<template>
  <div class="contain-company">
    <!-- 头部 -->
    <tzHeadline :title="type === 'edit' ? '编辑全局质检方案' : '新增全局质检方案'" :isShowBack="true" backText="返回">
      <template slot="btn">
    ...
    <el-form
      ...
      label-position="top">
        ...
        <el-row :gutter="20">
          <el-col :span="6">
            <el-form-item label="检验方案名称" prop="planName">
              <el-input placeholder="请输入" v-model.trim="formData.planName" maxlength="20" />
            </el-form-item>
          </el-col>
        </el-row>
        <!-- 抽检要求 -->
        ...
        <el-table :data="formData.checkPlanRangeVos" border style="width: 100%;" class="spotCheck" :header-cell-style="{'background-color': '#F9F9F9'}">
          ...
          <el-table-column prop="ratio" label="抽检比例" align="center" class-name="required-red">
            <template slot-scope="scope">
...
export default {
  ...
  data () {
    ...
    return {
      ...
      rules: {
        planName: [
          { required: true, message: '请输入检验方案名称', trigger: ['change', 'blur'] }
        ],
        specMethod: [
