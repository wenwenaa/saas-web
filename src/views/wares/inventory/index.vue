      ...
      <tzSearch @search="search" @clear="clear" :isShowExtend="true">
        <template slot="content">
          ...
          <el-form-item label="盘点仓库">
            <el-select
              v-model.trim="formData.baseWarehouseId"
              clearable
              filterable
              placeholder="请选择"
            >
    ...
    <el-table
        ...
        <template slot-scope="scope">
          <el-table
            ...
            <el-table-column align="center" prop="takingQuantity" label="盘点实际数量">
              <template slot-scope="scope">{{scope.row.takingQuantity}}</template>
            </el-table-column>
      ...
      <el-table-column align="center" prop="takingCode" label="盘点单号">
        <template slot-scope="scope">
          <div
            class="yellow"
            @click="goTo('detail', scope.row.stockTakingId)"
          >{{scope.row.takingCode}}</div>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="操作" fixed="right">
        <template slot-scope="scope">
          <div class="yellow" @click="goTo('detail', scope.row.stockTakingId)">详情</div>
        </template>
      </el-table-column>
    </el-table>
    <tzPagination
